...
const Education=()=>{
    return(
        <div className='MainContainer'>
          ...
          <div className='EducationContainer'>
            <div className='EducationDetails'>
               <h1>CDAC Center For Developemnt Of Advanced Computing Bengaluru - Karnataka</h1>
               <p>PG Diploma In IOT Certification Course</p>
               <p>Sept 2022 - March 2023</p>
            </div>
            <img src="https://res.cloudinary.com/ddeubkjvk/image/upload/v1755238058/CDAC_nkhage.jpg" alt="NSS-College-Image" className='institute'/>
          </div>
          <div className='EducationContainer'>
            <div className='EducationDetails'>
